...
public class UserServiceImpl implements UserService{
	...
	public String findUserId(HttpServletResponse response, String uemail) throws Exception {
	    ...
	    System.out.println("UserService findUserId Start----------------------------------------------------");
	    System.out.println("UserService findUserId parameter >> " + uemail);
	    
	    String id = userdao.findUserId(uemail);
	    
	    System.out.println("UserService findUserId result >> " + id);
	    System.out.println("UserService findUserId End----------------------------------------------------");
